...
final = must(final,
  ...
  '<meta name="description" content="Фінальна анкета мінікурсу: 35 запитань про практики основної програми Agentic Engineering по пʼяти стиках ланцюга. Результат показує найслабший стик і модулі, які його закривають.">',
  'description');
...
final = must(final,
  ...
  '<p class="intro">Тридцять пʼять запитань про практики основної програми Agentic Engineering, по сім на кожен стик ланцюга. Результат покаже, які стики тримаються після мінікурсу і які модулі основної програми закривають решту.</p>',
  'intro');
final = must(final, NOSCRIPT('questionnaire.md'), NOSCRIPT('final-questionnaire.md'), 'noscript');
final = must(final, '<!-- cta -->',
  '<div class="panel cta final-only" id="cta"><p class="panel-cap">Найслабші модулі</p><p id="cta-text"></p><p><a class="cta-link" href="https://agenticengineering.it.com/" rel="noopener">Залишити анкету</a></p></div>',
  'cta');
